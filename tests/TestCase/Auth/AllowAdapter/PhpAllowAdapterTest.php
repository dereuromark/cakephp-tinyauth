...
use TinyAuth\Auth\AllowAdapter\PhpAllowAdapter;

class PhpAllowAdapterTest extends TestCase {

	/**
	 * @var \TinyAuth\Auth\AllowAdapter\PhpAllowAdapter
	 */
	public $adapter;
	...
	public function setUp(): void {
		...
		$this->adapter = new PhpAllowAdapter();
	}
