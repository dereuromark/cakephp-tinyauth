...
use TinyAuth\Auth\BaseAuthenticate;
use TinyAuth\Auth\BaseAuthorize;
use TinyAuth\Auth\Storage\StorageInterface;
 ...
 */
abstract class LegacyAuthComponent extends Component implements EventDispatcherInterface {
	 ...
	 *
	 * @var array<\TinyAuth\Auth\BaseAuthenticate>
	 */
	 ...
	 *
	 * @var array<string, \TinyAuth\Auth\BaseAuthorize>
	 */
	 ...
	 * Storage object.
	 *
	 * @var \TinyAuth\Auth\Storage\StorageInterface|null
	 */
	protected $_storage;
	 ...
	 * in the same request
	 *
	 * @var \TinyAuth\Auth\BaseAuthenticate|null
	 */
	 ...
	 *
	 * @var \TinyAuth\Auth\BaseAuthorize|null
	 */
	...
	public function constructAuthorize(): ?array {
		...
		$global = [];
		if (isset($authorize[static::ALL])) {
			$global = $authorize[static::ALL];
			unset($authorize[static::ALL]);
		}
		foreach ($authorize as $alias => $config) {
			...
			/** @var \TinyAuth\Auth\BaseAuthorize $authorizeObject */
			$authorizeObject = new $className($this->_registry, $config);
			$this->_authorizeObjects[$alias] = $authorizeObject;
		}
	 ...
	 * @return \TinyAuth\Auth\BaseAuthorize|null
	 */
	...
	public function constructAuthenticate(): ?array {
		...
		$global = [];
		if (isset($authenticate[static::ALL])) {
			$global = $authenticate[static::ALL];
			unset($authenticate[static::ALL]);
		}
		foreach ($authenticate as $alias => $config) {
			...
			/** @var \TinyAuth\Auth\BaseAuthenticate $authenticateObject */
			$authenticateObject = new $className($this->_registry, $config);
			$this->_authenticateObjects[$alias] = $authenticateObject;
	...
	/**
	 * Set user record storage object.
	 *
	 * @param \TinyAuth\Auth\Storage\StorageInterface $storage
	 * @return void
	 */
	 ...
	 *
	 * @return \TinyAuth\Auth\Storage\StorageInterface
	 */
	public function storage(): StorageInterface {
		...
		/** @var \TinyAuth\Auth\Storage\StorageInterface $storage */
	 ...
	 * @return \Cake\Controller\Component|null
	 */
	 ...
	 * @return \TinyAuth\Auth\BaseAuthenticate|null
	 */
